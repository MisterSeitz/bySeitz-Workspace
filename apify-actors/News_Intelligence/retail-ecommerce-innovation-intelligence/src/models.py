...
class DatasetRecord(BaseModel):
    ...
    sentiment: Optional[str] = Field(None, description="Assessed business trend/impact (e.g., Highly Disruptive, Growth Trend, Informational).")
    category: Optional[str] = Field(None, description="The primary thematic category of the news article (e.g., Logistics/Supply Chain, Digital Marketing, Store Operations).")
    key_entities: Optional[List[str]] = Field(None, description="Key brands, platforms, technologies, or people mentioned in the article.")
