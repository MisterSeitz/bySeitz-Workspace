...
class DatasetRecord(BaseModel):
    ...
    sentiment: Optional[str] = Field(None, description="Assessed impact/interest level (e.g., High Hype, Moderate Interest, Informational).")
    category: Optional[str] = Field(None, description="The primary thematic category of the news article (e.g., Game Review, Tournament Results, Studio News).")
    key_entities: Optional[List[str]] = Field(None, description="Key games, teams, companies, or people mentioned in the article.")
