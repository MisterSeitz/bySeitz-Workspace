...
def strip_html_tags(text):
    ...
    if not text:
        return ""
    # Initialize 'clean' with the input text (FIXED: This prevents UnboundLocalError)
    clean = text
...
async def main():
    async with Actor:
        ...
        app = graph.compile()
        Actor.log.info("Starting AI News intelligence pipeline.")
        ...
        Actor.log.info("🎯 Venture Capital News intelligence pipeline completed successfully!")
